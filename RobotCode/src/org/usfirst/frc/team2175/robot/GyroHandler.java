...
public class GyroHandler extends SensorBase implements PIDSource,
        LiveWindowSendable {
    static final int kOversampleBits = 10;
    static final int kAverageBits = 0;
    static final double kSamplesPerSecond = 50.0;
    static final double kCalibrationSampleTime = Robot.properties
            .getGyroConfigTime();
    ...
    public void initGyro() {
        ...
        setDeadband(Robot.properties.getGyroDeadband());
     ...
     */
    public GyroHandler(AnalogInput channel) {
        m_analog = channel;
        if (m_analog == null) {
            throw new NullPointerException(
                    "AnalogInput supplied to Gyro constructor is null");
        }
        initGyro();
    }
    ...
    void setDeadband(double volts) {
        int deadband = (int) (volts * 1e9 / m_analog.getLSBWeight() * (1 << m_analog
                .getOversampleBits()));
    ...
    public double pidGet() {
        ...
        case 1: // These numbers are form PIDSource
            return getRate();
        case 2:
            return getAngle();
        default:
